...
namespace realware
{
    ...
    public:
        ...
        virtual sShader* CreateShader(const eCategory& renderPath, const std::string& vertexPath, const std::string& fragmentPath, const std::vector<sShader::sDefinePair>& definePairs = {}) = 0;
    ...
    {
    public:
        cOpenGLRenderContext(const cApplication* const app);
        ...
        virtual sShader* CreateShader(const eCategory& renderPath, const std::string& vertexPath, const std::string& fragmentPath, const std::vector<sShader::sDefinePair>& definePairs = {}) override final;
